...
B
B[L]    # returns a vector; be careful with this one!
B[L,  ] # returns the rows corresponding to TRUE values of L
B[ , L] # returns the columns corresponding to TRUE values of L
B[L, L] # returns entries that are in both prior matrices
```
