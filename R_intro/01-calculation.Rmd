...
There is a relationship between `%%` and `%/%` called *quotient-remainder* that
you should remember: `a == b*(a %/% b) + (a %% b)`. Let's try it out:
